...
- `https://raw.githubusercontent.com/fumasa/jellyfin-playlists-plus-plugin/main/manifest.json`

Release flow:
1. `git tag vX.Y.Z` and push the tag
2. GitHub Actions builds the zip, creates the release, and updates `manifest.json`
